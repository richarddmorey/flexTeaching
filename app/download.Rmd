...
renderUI({
  ...
  str = getURIdata(input$seed, getSecret(), input$data_format, values$assignment_list)
  HTML(str)
})
```
...
renderUI({
  ...
  res = values$assignment_list$getAssignment(input$seed, secret, assignmentDir, solutions = FALSE)
