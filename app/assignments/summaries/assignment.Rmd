...
```{r, echo=FALSE,include=solutions,results="asis"}
cat("
\\[
\\begin{eqnarray}
...
\\[
\\begin{eqnarray}
\\frac{\\sum_{i=1}^Nx_i}{N} &=& \\frac{",sum(x),"}{",N,"}\\\\
&=&",
mean(x),
"
\\end{eqnarray}
...
```{r, echo=FALSE,include=solutions,results="asis"}
cat("Below, the mean is represented graphically as a vertical red line with the data points in blue.")
```


```{r, echo=FALSE, fig.height=2,include=solutions}
